...
\hypersetup{
  ...
  pdftitle={Birth death catastrophe -- Definition and main results},
  pdfauthor={Adam Aldridge}
}

\title{Birth death catastrope -- Definition and main results}
\author{Adam Aldridge}
\date{Extracted from AA Thesis (Chapter~3)\\University of Leeds, November 2024}
...
\input{sections/10_variance_and_standard_deviation_of.tex}
\input{sections/11_variable_dependencies_on.tex}
