...
% rupture state H; released count W_t; burst size \Kb (never bare K, which
% is E[X_t^2]).
...
\hypersetup{
  ...
  pdftitle={The birth-death-catastrophe process: distribution theory, quasi-stationarity, and burst statistics},
  pdfauthor={Adam Aldridge}
}

\title{The birth--death--catastrophe process:\\
distribution theory, quasi-stationarity, and burst statistics}
\author{Adam Aldridge}
\date{Chapter 4a of AA Thesis --- University of Leeds\\Draft compiled \today}
