...
% is E[X_t^2]). Population: \Icell infected cells, \Vfree free particles.
...
\hypersetup{
  ...
  pdftitle={From one cell to a population: burst-aware renewal dynamics and the bursting-budding comparison},
  pdfauthor={Adam Aldridge}
}

\title{From one cell to a population:\\
burst-aware renewal dynamics and the bursting--budding comparison}
\author{Adam Aldridge}
\date{Chapter 4b of AA Thesis --- University of Leeds\\Draft compiled \today}
...
\input{sections/01_what_we_need.tex}
\input{sections/02_why_constant_release_fails.tex}
\input{sections/03_renewal_bmvr.tex}
\input{sections/04_effective_parameters_r0_identifiability.tex}
\input{sections/05_flooding_and_growth_rate_tradeoff.tex}
\input{sections/06_spectrum_of_release_models.tex}
\input{sections/07_hiv_contrast.tex}
