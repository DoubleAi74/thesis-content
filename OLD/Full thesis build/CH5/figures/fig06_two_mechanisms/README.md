# fig06 — two mechanisms

Shipped as **Figure 5.6**, `dist:fig:two-mechanisms`, included from `sections/06_burst_size.tex`.

## Regenerate

```sh
cd figures/fig06_two_mechanisms/src && python3 generate.py
```
