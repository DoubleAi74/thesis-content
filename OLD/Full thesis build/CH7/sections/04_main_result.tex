...
\begin{figure}[!htbp]
  ...
  \caption{No-catastrophe probabilities $S(t)$ (type~1 start) and $G(t)$ (type~2 start) at fixed rates
    ...
    Solid curves: closed form of \cref{thm:main}; open circles: RK4 integration of the unscaled backward ODEs.
