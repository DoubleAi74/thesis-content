...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{figures/N4a_4_three_burst_means.pdf}
\caption{Three distinct averages at
$(\lambda,\mu,\delta)=(1,0.2,0.05)$. The unconditional mean release
$V_\infty=13.99$ includes cells that never burst; conditioning on eventual
burst gives $V_\infty/(1-b)=a/(a-1)=17.23$; conditioning on a very late
eventual burst gives the size-biased limit $(a+1)/(a-1)=33.46$. Keeping the
conditioning explicit removes the apparent circularity.}
\label{fig:N4a_4}
\end{figure}
