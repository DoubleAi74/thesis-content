...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/NX_1_trilogy_handoff.pdf}
\caption{Logical handoff across the trilogy: closed single-cell moments and fixation functions (Chapter~3), distributional laws and multiplicity (Chapter~4a), and burst-aware renewal kernels in population dynamics (Chapter~4b).}
\label{fig:NX_1_trilogy_handoff}
\end{figure}
