...
$p=\tfrac12$, and the binding constraint is that as the process is
...
First, use the product rather than the raw ratio $S_n/(2p)^n$: only the product
comes with the certificate \cref{a:eq:producttailbound}.
