...
population at a stroke. Two extensions then leave the time-homogeneous setting:
processes whose rates vary with time, worked through on a logistic model of
diversification in which the birth rate declines as a niche fills; and coupled
systems in which a deterministic differential equation and a Markov chain each
drive the other, whose schematic instance here is a compartment that ruptures into
a shared medium.
...
the process survives at all. The phenomenology is recorded in
