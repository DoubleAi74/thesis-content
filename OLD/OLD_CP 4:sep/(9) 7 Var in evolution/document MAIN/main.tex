...
\hypersetup{
  ...
  pdftitle={Variability in evolution},
  pdfauthor={Adam Aldridge}
}

\title{Variability in evolution}
\author{Adam Aldridge}
\date{Extracted from AA Thesis (Chapter~7)\\University of Leeds, November 2024}
...
\input{sections/02_push_of_the_past_and_pull_of_the_present.tex}
\input{sections/03_logistic_speciation.tex}
\input{sections/04_model_specification_and_results_no_death_case_analytic_solou.tex}
\input{sections/05_pimental.tex}
\input{sections/06_allegorical_model_of_rise_run_ruin_rejuvenation.tex}
\input{sections/07_bardo_thodol.tex}
\input{sections/08_birth_plague_model.tex}
\input{sections/09_density_dependent_vitallity_birth_plague_model.tex}
