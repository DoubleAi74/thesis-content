...
which it comes. The figures are direct exports from the accompanying
\explorerlink{https://files.volvox.site/users/69b423f5faa2bfbb5b696c61/pages/69b423fcfaa2bfbb5b696c77/files/1787185484035-q1arbz-koenigs_explorer.html}{interactive program}.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.313\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{pictures/1.jpg}
        \caption{Rapid capture.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.311\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{pictures/2.jpg}
        \caption{Slower capture.}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.326\textwidth}
        \centering
        \includegraphics[width=\linewidth,keepaspectratio]{pictures/3.jpg}
...
\begin{figure}[t]
    ...
    quasi-stationary mean $1/A(p)=2.980439$.
      \explorerlink{https://files.volvox.site/users/69b423f5faa2bfbb5b696c61/pages/69b423fcfaa2bfbb5b696c77/files/1787185484035-q1arbz-koenigs_explorer.html}{Koenigs visualiser}}
