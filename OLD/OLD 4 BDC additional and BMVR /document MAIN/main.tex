...
\hypersetup{
  ...
  pdftitle={Birth death catastrophe -- further results and potential use},
  pdfauthor={Adam Aldridge}
}

\title{Birth death catastrophe -- further results and potential use}
\author{Adam Aldridge}
\date{Extracted from AA Thesis (Chapter~4)\\University of Leeds, November 2024}
...
\input{sections/02_specification_of_rupture_state.tex}
...
\input{sections/09_potential_application_in_bmvr.tex}
