...
% Shared style for the pgfplots panels in Section 2.
\pgfplotsset{
    myplotstyle/.style={
...
\input{sections/02_galton_watson.tex}
\input{sections/03_quasi_stationarity.tex}
\input{sections/04_small_populations.tex}
\input{sections/05_constant_A.tex}
\input{sections/06_method_of_characteristics.tex}
