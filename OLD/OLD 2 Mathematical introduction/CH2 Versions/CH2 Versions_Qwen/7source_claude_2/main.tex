...
% Equation cross-references as bare numbers in parentheses, mathematical style.
\crefformat{equation}{(#2#1#3)}
\Crefformat{equation}{(#2#1#3)}
\crefrangeformat{equation}{(#3#1#4)--(#5#2#6)}
\crefmultiformat{equation}{(#2#1#3)}{ and (#2#1#3)}{, (#2#1#3)}{ and (#2#1#3)}

% Shared style for the fixed-point panels of the survival recursion.
\pgfplotsset{
    myplotstyle/.style={
...
\title{Mathematical background\\[4pt]\large Branching, quasi-stationarity and absorption models}
...
\input{sections/02_foundations.tex}
\input{sections/03_galton_watson.tex}
\input{sections/04_conditioning.tex}
\input{sections/05_small_populations.tex}
\input{sections/06_constant_A.tex}
\input{sections/07_characteristics.tex}
\input{sections/08_outlook.tex}
