...
The absorption--birth--death model does not have the multilinear form
\cref{m:eq:multilinear}, and its coefficient extraction --- which separates a
$y$-binomial factor from a univariate convolution --- is recorded with the model
itself, in \cref{m:sec:recovery}.
