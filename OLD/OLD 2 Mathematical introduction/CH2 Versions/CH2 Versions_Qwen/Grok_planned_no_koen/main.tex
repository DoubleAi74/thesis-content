...
\hypersetup{
  ...
  pdftitle={Mathematical background},
  pdfauthor={Adam Aldridge}
}

\title{Mathematical background}
\author{Adam Aldridge}
\date{Chapter~2 rewrite (plan v1.2)\\University of Leeds}
...
\begin{abstract}
\noindent
Background material for the thesis: Markovian language, branching criticality, quasi-stationarity, and analytical tools for continuous-time population models. This draft is being rewritten in stages against a frozen structure plan (Paths~A--C).
\end{abstract}
...
\input{sections/03_discrete_branching.tex}
\input{sections/04_continuous_birth_death.tex}
\input{sections/05_small_populations.tex}
\input{sections/06_checkpoint.tex}

% --- Path B ---
\input{sections/07_method_of_characteristics.tex}

% --- Path C ---
\input{sections/08_ap_and_koenigs.tex}

% --- Appendices ---
\appendix
\input{sections/app_a_core.tex}
\input{sections/app_b_moc.tex}
\input{sections/app_c_koenigs.tex}
