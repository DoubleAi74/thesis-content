...
% Equation cross-references as bare numbers in parentheses.
\crefformat{equation}{(#2#1#3)}
\Crefformat{equation}{(#2#1#3)}
\crefrangeformat{equation}{(#3#1#4)--(#5#2#6)}
\crefmultiformat{equation}{(#2#1#3)}{ and (#2#1#3)}{, (#2#1#3)}{ and (#2#1#3)}

% Shared style for the pgfplots panels in the Galton--Watson section.
\pgfplotsset{
    myplotstyle/.style={
...
\title{Mathematical introduction\\[4pt]\large Branching, quasi-stationarity and absorption models}
...
\input{sections/04_quasi_stationarity.tex}
