...
time-homogeneous setting: processes whose rates vary with time, and coupled systems
in which a deterministic differential equation and a Markov chain each drive the
other.
