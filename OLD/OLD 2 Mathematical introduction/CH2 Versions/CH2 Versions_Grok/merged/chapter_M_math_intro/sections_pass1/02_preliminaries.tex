...
Galton--Watson extinction probability in \cref{m:sec:gw}, is the \emph{first-step}
...
In continuous time the analogous identities are obtained from the generator rather
than from $P$; both versions appear repeatedly below.
