...
\hypersetup{
  ...
  pdftitle={Conclusion -- Evolved strategy of Yersinia Pestis},
  pdfauthor={Adam Aldridge}
}

\title{Conclusion -- Evolved strategy of Yersinia Pestis}
\author{Adam Aldridge}
\date{Extracted from AA Thesis (Chapter~8)\\University of Leeds, November 2024}
