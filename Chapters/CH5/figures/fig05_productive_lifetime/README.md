# fig05 — productive lifetime

Shipped as **Figure 5.5**, `dist:fig:lifetime`, included from `sections/05_quasi_stationary.tex`.

## Regenerate

```sh
cd figures/fig05_productive_lifetime/src && python3 generate.py
```
