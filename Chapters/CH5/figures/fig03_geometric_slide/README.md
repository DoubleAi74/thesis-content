# fig03 — geometric slide

Shipped as **Figure 5.3**, `dist:fig:slide`, included from `sections/04_geometric.tex`.

## Regenerate

```sh
cd figures/fig03_geometric_slide/src && python3 generate.py
```
