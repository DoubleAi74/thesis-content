...
def make_figure() -> None:
    ...
    fig, ax = plt.subplots(figsize=(5.07, 3.10))
    bars = ax.bar(
        positions,
        values,
        width=0.86,
    ...
    ax.annotate(
        ...
        xy=(1.12, 38.0),
        xytext=(0.33, 38.0),
        arrowprops={"arrowstyle": "->", "color": style_rc.SOFT, "linewidth": 0.9},
    )
    ax.text(
        0.725,
        38.6,
        rf"remove no-burst mass $b={checked['b']:.4f}$",
        ha="center",
        va="bottom",
        fontsize=9,
        color=style_rc.SOFT,
