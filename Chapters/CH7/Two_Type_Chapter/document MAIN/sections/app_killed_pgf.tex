...
\]
and keep the notation $r_{2,\pm}$, $\alpha_2$, $\hat q_2$, $h$, and $A,B,C$ from \cref{sec:autonomous,sec:main_result}. In the generic regime of \cref{thm:main}, only the starting coordinate changes:
\begin{equation}
