...
\centering
\includegraphics[width=0.80\textwidth]{figures/fig_triumph/bruegel_triumph}
\caption*{(a) Bruegel, \textit{The Triumph of Death}, c.~1562.}
\end{subfigure}
...
\begin{subfigure}{\textwidth}
\centering
\includegraphics[width=0.58\textwidth]{figures/fig_plague_naples/spadaro_naples_1656}
\caption*{(b) Spadaro, \textit{Piazza Mercatello} during the plague of 1656.}
\end{subfigure}
...
thought to have lost something close to half its population in that year. Both
public domain.}
