# fig15 — burst vs budding

Shipped as **Figure 5.15**, `dist:fig:budding`, included from `sections/11_bursting_budding.tex`.

## Regenerate

```sh
cd figures/fig15_burst_vs_budding/src && python3 generate.py
```
