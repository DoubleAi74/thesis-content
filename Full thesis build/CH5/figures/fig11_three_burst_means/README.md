# fig11 — three burst means

Shipped as **Figure 5.11**, `dist:fig:threemeans`, included from `sections/08_conditional_means.tex`.

## Regenerate

```sh
cd figures/fig11_three_burst_means/src && python3 generate.py
```
